...
# Aggiungere flag "revisor" alla tabella degli user -> boolean
# Creare comando artisan custom che data una mail renda un dato utente revisore -> artisan command make user revisor
